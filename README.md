...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c372b4c8-165f-4283-83ea-4c77c9facd40
```

> `c372b4c8-165f-4283-83ea-4c77c9facd40` is the password of the certificate, you can change it to any password you want.
